...
const myInfoSingPassProfiles = Object.entries(myinfo.v3.personas).map(
  ([nric, persona]) => ({
    nric,
    uuid: persona.uuid.value,
    claims: persona,
  }),
)

const baseSingPassProfiles = [
  { nric: 'S9812379B', uuid: 'a9865837-7bd7-46ac-bef4-42a76a946424' },
...
const mergedSingPassProfiles = [
  ...myInfoSingPassProfiles,
  ...baseSingPassProfiles.filter(
    (profile) => !myInfoSingPassProfiles.some((p) => p.nric === profile.nric),
  ),
]

const oidc = {
  singPass: mergedSingPassProfiles,
  corpPass: [
    {
      nric: 'S9812379B',
      uuid: 'a9865837-7bd7-46ac-bef4-42a76a946424',
      name: 'Name of S9812379B',
